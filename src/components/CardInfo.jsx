...
import { decrementByOne, incrementByOne, removeItem } from "../Redux/cartSlice";
    ...
    <div className="w-full h-30  p-2 flex justify-between items-start rounded-2xl border-slate-400 shadow-2xl">
      <div className="w-[60%] h-full  flex gap-5 ">
        ...
        <div className="w-[45%] h-full flex flex-col gap-5 text-black  ">
          ...
          <div className=" w-9/10 h-8 bg-slate-400 flex items-center  overflow-hidden rounded-md text-xl border border-green-400 ">
            <button
              className="bg-white w-[30%] h-full cursor-pointer hover:bg-slate-200 "
              onClick={() => qty > 0 && dispatch(decrementByOne(id))}
            >
              -
            </button>
            ...
            <button
              className="bg-white w-[30%] h-full cursor-pointer hover:bg-slate-200 "
              onClick={() => dispatch(incrementByOne(id))}
            >
              +
            </button>
          </div>
